...
type HoopSpotPageProps = {
    hoopSpot: HoopSpot
}

const HoopSpotPage: FunctionComponent<HoopSpotPageProps> = (props) => {
                        ...
                        <div className="grid gap-5 justify-center items-center">
                            {
                                nearbyHoopSpots.length > 0 ? nearbyHoopSpots.map(nearbyHoopSpot => (
                                    <a href={`/hoopspot/${nearbyHoopSpot.slug}`} key={nearbyHoopSpot.uuid}>
