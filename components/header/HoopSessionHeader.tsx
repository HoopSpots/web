        ...
        return (
            <div className="lg:flex lg:items-center lg:justify-between">
                <div className="flex-1 min-w-0">
                    <h4 className="text-lg font-semibold leading-5 text-primary mb-1">{dayjs(this.props.hoopSession.start_time).format('dddd, MMM D, YYYY')}</h4>
                    ...
                    <div className="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap">
                        ...
                        <div className="mt-2 flex items-center text-sm leading-5 text-gray-500 sm:mr-6">
                            ...
                            {this.props.hoopSession.hoopspot?.full_address}
                        </div>
                    </div>
                </div>
