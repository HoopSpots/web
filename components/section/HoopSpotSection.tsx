...
export class HoopSpotSection extends Component<HoopSpotSectionProps, HoopSpotSectionState> {
    ...
    render() {
        return (
            ...
            <span className="flex">
              <svg className="w-6 h-6 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path
                  fillRule="evenodd"
                ...
                {this.props.hoopSpot.full_address}
                                ...
                                <span className="flex">
              <svg className="w-6 h-6 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path
                  d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"/></svg>
              ...
              <svg className="w-5 h-5 mx-1 text-gray-600" fill="currentColor" viewBox="0 0 50 50"
                  ...
                  d="M40,0H10C4.486,0,0,4.486,0,10v30c0,5.514,4.486,10,10,10h30c5.514,0,10-4.486,10-10V10C50,4.486,45.514,0,40,0z M39,17h-3 c-2.145,0-3,0.504-3,2v3h6l-1,6h-5v20h-7V28h-3v-6h3v-3c0-4.677,1.581-8,7-8c2.902,0,6,1,6,1V17z"/></svg>
            ...
            <span className="flex items-center">
              ...
              <svg className="w-5 h-5 mx-1 text-gray-600" fill="currentColor" viewBox="0 0 24 24"
                        ...
                        <div className="border-b border-gray-200">
                            <div className="flex justify-between items-center">
                                <nav className="flex -mb-px">
                                    <a href="#"
                                       className="group inline-flex items-center py-4 px-1 border-b-2 border-transparent font-medium text-xs md:text-sm leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300">
                                        <svg
                                    ...
                                    <a href="#"
                                       className="ml-8 group inline-flex items-center py-4 px-1 border-b-2 border-orange-500 font-medium text-sm leading-5 text-orange-600 focus:outline-none focus:text-orange-800 focus:border-orange-700"
                                       aria-current="page">
                                        <svg
                                            className="-ml-0.5 mr-2 h-5 w-5 text-orange-500 group-focus:text-indigo-600"
                ...
                <button type="button"
                  ...
                  Join<svg className="-mr-0.5 ml-2 h-4 w-4" fill="currentColor" viewBox="0 0 20 20"
                ...
                <button type="button"
                 ...
                 <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path
                     d="M10 6a2 2 0 110-4 2 2 0 010 4zM10 12a2 2 0 110-4 2 2 0 010 4zM10 18a2 2 0 110-4 2 2 0 010 4z"/></svg>
                </button>
              </span>
                ...
                <div className="container mx-auto py-8 px-4 md:px-0">
                    <div className="bg-white rounded-md shadow-md py-8 px-4 w-full md:max-w-4xl mx-auto">
                        <div className="flex justify-between relative">
                            ...
                            <SortMemberDropdown selectSortOption={this.selectSortMember} showDropdown={this.state.showDropdown}/>
                        </div>
                        ...
                        <FullMemberList members={this.props.hoopSpot.members}/>
                    </div>
                </div>
            </section>
        );
